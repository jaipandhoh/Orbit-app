...
export default function WorkspaceSwitcher() {
  ...
  return (
    <div className="flex items-center gap-2" ref={dropdownRef}>
      ...
      {/* Explicit Create Team Button */}
      <button
        onClick={() => { setOpen(true); setCreating(true); }}
        className="flex items-center gap-1.5 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 transition shadow-sm"
      >
        <Plus className="w-4 h-4" />
        Create Team
      </button>
